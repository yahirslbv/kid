...
import 'package:graficacion_ai/features/metodos_numericos/screens/rk4_screen.dart';

void main() {
  Widget createWidgetUnderTest() {
    return const MaterialApp(
      home: Scaffold( // Envolvemos en Scaffold porque el widget raíz es Padding
        body: RungeKuttaScreen(),
      ),
    );
  }

  group('Pruebas de RungeKuttaScreen (RK4)', () {
    ...
    testWidgets('Calcula el método RK4 con los valores por defecto correctamente', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());

      // Evaluamos con los valores por defecto
      final botonCalcular = find.widgetWithText(ElevatedButton, 'Calcular RK4');
      ...
      // Verificamos que la tabla de iteraciones se haya dibujado (con columnas k1, k2, k3, k4)
